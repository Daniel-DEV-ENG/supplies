...
function ProductHeader() {
	...
	const [createProduct] = useCreateSalesManMutation();
	const [saveProduct] = useUpdateSalesManMutation();
	const [removeProduct] = useDeleteSalesManMutation();
			...
			<div className="flex flex-col items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
				...
				>
					...
					>
						...
						<span className="flex mx-4 font-medium">مندوب مبيعات</span>
					</Typography>
				</motion.div>
