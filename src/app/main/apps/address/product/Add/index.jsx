...
import { useCreateAddressMutation } from '../../CitiesApi';
...
export default function AddressDialog({address}) {
  console.log("🚀 ~ AddressDialog ~ address:", address)
  const [open, setOpen] = React.useState(false);
  const [createCity] = useCreateAddressMutation();
  ...
  const HandleSaveCategory = (data) => {
    ...
    createCity({id:address.id,data:data})
    handleClose();
